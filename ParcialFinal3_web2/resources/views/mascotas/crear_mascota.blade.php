...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center"><h4>{{ __('Crear Mascota') }}</h4></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('mascotas.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cedula_cliente" type="text" class="form-control @error('cedula_cliente') is-invalid @enderror" name="cedula_cliente" value="{{ old('cedula_cliente') }}" required autocomplete="cedula_cliente" autofocus>
